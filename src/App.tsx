...
const TESTIMONIAL_IMAGES = [
  "https://i.ibb.co/0y8DDYnF/dp01.png",
  "https://i.ibb.co/fVKCMF4F/dp05.png",
  "https://i.ibb.co/84t8Sg4d/dp02.png",
  "https://i.ibb.co/0RdL5vkJ/dp06.png",
  "https://i.ibb.co/jkPcThRf/dp03.png",
  "https://i.ibb.co/bMZ5jSQ3/dp04.png"
];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Preload remaining images in background after initial render to make the page extremely fast
    const preloadTimer = setTimeout(() => {
      const imagesToPreload = [
        ...TESTIMONIAL_IMAGES,
        ...CAROUSEL_ONE_IMAGES,
        ...CAROUSEL_TWO_IMAGES,
        "https://i.ibb.co/bjswWkF7/Chat-GPT-Image-26-de-jun-de-2026-20-55-33.png",
        "https://i.ibb.co/cKc1VSFm/img01.png",
        "https://i.ibb.co/wFH6NYqV/img02.png",
        "https://i.ibb.co/1GnmMvkT/img03.png"
      ];
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text font-sans antialiased relative selection:bg-brand-lightgold selection:text-brand-darkblue overflow-x-hidden">
      ...
      <main className="relative py-4 md:py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <section id="social-proof-section" className="w-full max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-2 mb-2 border-t border-brand-gold/15">
        ...
        <section id="how-to-use-section" className="w-full max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-2 mb-6">
          <div className="text-center max-w-3xl mx-auto mb-8">
        ...
        <section id="perfect-for-section" className="w-full max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 mt-2 mb-10">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-2xl sm:text-3xl font-poppins font-bold text-[#0F3157] tracking-tight mb-3">
              Perfeito para quem ama a Palavra de Deus
            </h2>
            <p className="text-xs sm:text-sm text-[#2B2B2B]/90 leading-relaxed font-sans max-w-2xl mx-auto">
              Uma coleção criada para fortalecer sua caminhada com Deus, tornar sua leitura da Bíblia ainda mais especial e compartilhar sua fé com quem você ama.
            </p>
          </div>

          {/* Grid Moderno de 6 Cards Premium */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* Card 1 */}
            <div className="bg-white rounded-[24px] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 p-6 sm:p-8 flex flex-col text-left border border-[#C89B3C]/10 relative group">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#E4C97A]/20 to-[#C89B3C]/10 border border-[#C89B3C]/30 text-xl flex items-center justify-center mb-5 shadow-inner">
                <span>📖</span>
              </div>
              <h3 className="text-base sm:text-lg font-poppins font-bold text-[#0F3157] mb-2.5">
                Para sua Bíblia
              </h3>
              <p className="text-xs sm:text-sm text-[#2B2B2B]/85 leading-relaxed font-sans">
        ...
        <section id="exclusive-gallery-section" className="w-full bg-[#F8F6F2] py-12 px-4 sm:px-6 lg:px-8 mt-2 mb-8 border-t border-[#C89B3C]/10 overflow-hidden relative">
          
          {/* Custom style for seamless marquee translation */}
          <style dangerouslySetInnerHTML={{__html: `
            ...
            .animate-marquee-infinite-right {
              display: flex;
              width: max-content;
              animation: marquee-scroll-right 45s linear infinite;
            }
            .animate-marquee-infinite-right:hover {
              animation-play-state: paused;
            }
          `}} />
          ...
          <div className="text-center max-w-3xl mx-auto mb-8">
            <h2 className="text-2xl sm:text-3xl font-poppins font-bold text-[#0F3157] tracking-tight mb-3 leading-tight">
              Descubra uma coleção exclusiva de Marcadores Cristãos Premium
            </h2>
            <p className="text-xs sm:text-sm text-[#2B2B2B]/90 leading-relaxed font-sans max-w-2xl mx-auto">
              Cada marcador foi cuidadosamente desenvolvido com ilustrações inspiradoras, versículos bíblicos e acabamento elegante em tons de azul-marinho e dourado.
            </p>
          ...
          {/* FIRST CAROUSEL: Sliding left */}
          <div className="relative w-full overflow-hidden py-3 select-none">

            <div className="animate-marquee-infinite gap-4 sm:gap-6">
              {/* Render first carousel images twice for perfect seamless infinite loop */}
              {CAROUSEL_ONE_IMAGES.map((url, index) => (
                <div 
                  key={`marquee-1-a-${index}`} 
                  className="w-[135px] sm:w-[180px] shrink-0 p-1.5 bg-white rounded-[20px] shadow-sm hover:shadow-md border border-[#C89B3C]/10 transition-all duration-300 hover:scale-[1.05] hover:border-[#C89B3C]/40 group"
                >
                  {/* Bookmark image with wider 5.5x17 aspect ratio */}
                  <div className="aspect-[5.5/17] w-full bg-neutral-100 rounded-[14px] overflow-hidden relative shadow-inner">
                    <img 
                      src={url} 
                    ...
                    />
                    <div className="absolute bottom-1.5 right-1.5 px-1.5 py-0.5 rounded-md bg-[#0F3157]/95 text-[#E4C97A] text-[8px] font-mono tracking-wider font-semibold shadow">
          ...
          {/* SECOND CAROUSEL: Sliding right */}
          <div className="relative w-full overflow-hidden py-3 mt-4 select-none">

            <div className="animate-marquee-infinite-right gap-4 sm:gap-6">
              {/* Render second carousel images twice for perfect seamless infinite loop */}
              {CAROUSEL_TWO_IMAGES.map((url, index) => (
                <div 
                  key={`marquee-2-a-${index}`} 
                  className="w-[135px] sm:w-[180px] shrink-0 p-1.5 bg-white rounded-[20px] shadow-sm hover:shadow-md border border-[#C89B3C]/10 transition-all duration-300 hover:scale-[1.05] hover:border-[#C89B3C]/40 group"
                >
                  {/* Bookmark image with wider 5.5x17 aspect ratio */}
                  <div className="aspect-[5.5/17] w-full bg-neutral-100 rounded-[14px] overflow-hidden relative shadow-inner">
                    ...
                    />
                    <div className="absolute bottom-1.5 right-1.5 px-1.5 py-0.5 rounded-md bg-[#0F3157]/95 text-[#E4C97A] text-[8px] font-mono tracking-wider font-semibold shadow">
                      #{String((index % 25) + 26).padStart(2, '0')}
                    </div>
                  </div>
                </div>
              ))}
        ...
        <section id="collections-grid-section" className="w-full bg-[#0F3157] py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <section id="full-package-section" className="w-full bg-gradient-to-b from-[#F8F6F2] to-[#FFFDFC] py-10 px-4 sm:px-6 lg:px-8 border-y-2 border-[#C89B3C]/30 overflow-hidden relative shadow-inner">
        ...
        <section id="exclusive-bonuses-section" className="w-full bg-[#F8F6F2] py-10 px-4 sm:px-6 lg:px-8 border-t border-[#C89B3C]/25 relative overflow-hidden">
        ...
        <section id="oferta-principal" className="w-full bg-[#F8F6F2] py-10 px-4 sm:px-6 lg:px-8 border-t border-[#C89B3C]/25 relative overflow-hidden">
        ...
        <section id="garantia-7-dias" className="w-full bg-white py-8 px-4 sm:px-6 lg:px-8 border-t border-neutral-100 relative overflow-hidden">
          <div className="max-w-3xl mx-auto relative z-10">
        ...
        <section id="faq-section" className="w-full bg-[#F8F6F2] py-14 px-4 sm:px-6 lg:px-8 border-t border-[#C89B3C]/20">
        ...
        <section id="final-cta-section" className="w-full bg-[#091F38] py-16 px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
